...
parser.add_argument('--tag', default="grayonly", type=str, help="Experiment ID")
...
if args.color == 'gray':
    print('using gray dataloader')
    transform_test = transforms.Compose([
        transforms.Grayscale(num_output_channels=3),
        transforms.ToTensor(),
    ])
elif args.color == 'color':
    print('using color dataloader')
    transform_test = transforms.Compose([
        transforms.ToTensor(),
    ])
else:
    raise ValueError("invalid color argument '{}'".format(args.color))
...
if __name__ == "__main__":
    ...
    expt_id = "{}_{}_resnet{}_cifar{}".format(
        args.tag,
