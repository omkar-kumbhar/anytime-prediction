...
from custom_transforms import AddGaussianBlur

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
torch.manual_seed(100)
torch.cuda.manual_seed(100)

parser = argparse.ArgumentParser(description='SCAN Blur Inference')
...
parser.add_argument('--blur', default=0.0, type=float, help="Gaussian SD value to apply")
...
if args.depth == 50:
    net = sresnet.resnet50(num_classes=args.class_num, align="CONV", pretrained=False)
    print("using resnet 50")
if args.depth == 101:
    net = sresnet.resnet101(num_classes=args.class_num, align="CONV", pretrained=False)
    print("using resnet 101")
if args.depth == 152:
    net = sresnet.resnet152(num_classes=args.class_num, align="CONV", pretrained=False)
...
if __name__ == "__main__":
    ...
    expt_id = "{}_{}_resnet{}_cifar{}_blur{}".format(
        args.tag,
