...
parser.add_argument('--tag', default="gray", type=str, help="Experiment ID")
parser.add_argument('--data-root', type=str, help="Path to dataset root or where it should be downloaded")
parser.add_argument('--color', default="gray", type=str, help="Color to be used. Options: gray (default), color")
