...
class MSDNetMod(nn.Module):
    def __init__(self, args):
        super(MSDNetMod, self).__init__()
    ...
    def _build_classifier_cifar(self, nIn, num_classes):
        interChannels1, interChannels2 = 16, 16 # smallest model (from paper)
        # interChannels1, interChannels2 = 32, 32 # medium model (for backbone comparison)
        # interChannels1, interChannels2 = 128, 128 # large model (for backbone comparison)
        conv = nn.Sequential(
